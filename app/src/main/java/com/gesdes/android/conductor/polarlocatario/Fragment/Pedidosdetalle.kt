...
import com.gesdes.android.conductor.polarlocatario.Pedidos
...
URL += getString(R.string.URL) + "ObtenerPedidosPorPkTienda"
    ...
    override fun onCreateView(
        ...
        var rootView =inflater.inflate(R.layout.activity_detalle, container, false)
